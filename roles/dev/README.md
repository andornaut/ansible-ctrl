...
| app-entries                                                     | Desktop entry overrides from `dev_app_entry_overrides`, the same mechanism as the [desktop](../desktop/README.md) role's. Overrides no longer named are removed                                           |
