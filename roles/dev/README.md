...
| [sops](https://github.com/getsops/sops) | Encrypted file editor. No [age](https://github.com/FiloSottile/age) package is installed: sops links the library, and faramir mints keypairs with `faramir sops keygen` |
