...
This role automates the deployment and configuration of a complete home automation stack including Home Assistant, Frigate NVR, and Mosquitto MQTT broker. It provides comprehensive support for voice and AI-powered home automation, camera management, and device integration.
...
- Hardware support including:
  ...
  - AirGradient sensors
  - Various other smart home devices
- Network Video Recorder (NVR) stack with AI object-detection via Frigate+
- Support for custom cards and integrations
