...
| [`/usr/local/bin/unrart`](./templates/unrart) | Extract rar and zip archives in a directory up to 5 levels deep, skipping dot-directories                                                                           |
...
| Constraint                                                                                                                                                                                                           | Detail                                                                                                                                                                                     |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `mvt`, `synct` and `orgt` are each generated with one call per host in `groups['torrent']`, from that host's own `hostvars[host].torrent_root_directory`, appending the `watch/` and `completed/` subdirectory names | The role's `torrent_watch_directory` and `torrent_completed_directory` would name one host's paths for every host                                                                          |
...
| A file already on disk is never overwritten                                       | `unrar -o-` and `unzip -n` each skip it                                                                                                                                                                                                                                                                                  |
| rar and zip only                                                                  | Both have an index, so a file already extracted is skipped without being decompressed. A `.tar.gz` or `.tar.bz2` has none and would be decompressed again on every pass                                                                                                                                                  |
